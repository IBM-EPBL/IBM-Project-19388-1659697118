...
def userlogin():
    ...
    if request.method == 'POST':
        ...
        if dataframe.empty:
            ...
            return render_template('index1.html', data=engine.execute("SELECT * FROM Employee_Data").fetchall())
...
def submit_data():
    ...
    print(articles)
    return render_template('news1.html', articles=articles, name=name)
